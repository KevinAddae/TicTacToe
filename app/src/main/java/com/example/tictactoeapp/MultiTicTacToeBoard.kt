...
class MultiTicTacToeBoard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_multi_tic_tac_toe_board)
        //sets up all the ImageViews.
        topL = findViewById(R.id.board_multiTopLeft)
        topM = findViewById(R.id.board_multiTopMiddle)
        topR = findViewById(R.id.board_multiTopRight)
        midL = findViewById(R.id.board_multiMidLeft)
        mid = findViewById(R.id.board_multiMid)
        midR = findViewById(R.id.board_multiMidRight)
        botL = findViewById(R.id.board_multiBotLeft)
        botM = findViewById(R.id.board_multiBotMid)
        botR = findViewById(R.id.board_multiBotRight)

        //Sets up the linear layout
        bgTopL = findViewById(R.id.bg_multiTopL)
        bgTopM = findViewById(R.id.bg_multiTopM)
        bgTopR = findViewById(R.id.bg_multiTopR)
        bgMidL = findViewById(R.id.bg_multiMidL)
        bgMid = findViewById(R.id.bg_multiMid)
        bgMidR = findViewById(R.id.bg_multiMidR)
        bgBotL = findViewById(R.id.bg_multiBotL)
        bgBotMid = findViewById(R.id.bg_multiBotM)
        bgBotR = findViewById(R.id.bg_multiBotR)
        //sets up the text view
        winner = findViewById(R.id.boardMulti_resultMsg)
